...
import DealMockup from "./pages/DealMockup";
...
function AppInner() {
  ...
  const devRoutes: Record<string, string> = { '#/deco-compare': 'deco-compare', '#/board-demo': 'board-demo', '#/sounds': 'sounds', '#/deal-mockup': 'deal-mockup' };
